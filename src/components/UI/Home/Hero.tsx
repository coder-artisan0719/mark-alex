    ...
    >
      ...
      >
        <div className="overflow-hidden relative rounded-[50%] w-[97%] h-[97%] border border-solid border-white">
          <Image draggable={false} src="/images/profile.jpeg" fill alt={'Sam Avatar'} />
        </div>
      </div> */}

      <div className={'lg:ml-[40px] flex flex-col items-center lg:items-start'}>
        <h1 className="text-[34px] lg:text-[78px] lg:mb-[3px]">I am Mark Alex,</h1>
        ...
        <div className={'flex flex-col lg:flex-row items-center gap-[25px] px-0 py-[30px]'}>
          <div className="flex items-center gap-[20px]">
            <Link
              href={'mailto:mark.alex71916@gmail.com'}
              target="_blank"
              className={
          ...
          <div className={'flex items-center gap-[20px]'}>
            ...
            <a
              href="http://www.linkedin.com/in/mark-alex0719/"
              target="_blank"
              className="flex items-center justify-center text-white"
            >
